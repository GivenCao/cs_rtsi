...
"" + NEW_LINE +
//"    global servoc_target" + NEW_LINE +
//"    global servoc_acceleration" + NEW_LINE +
//"    global servoc_velocity" + NEW_LINE +
//"    global servoc_blend" + NEW_LINE +
//"" + NEW_LINE +
//"    servoc_target = [0, 0, 0, 0, 0, 0]" + NEW_LINE +
//"    servoc_acceleration = 1.2" + NEW_LINE +
//"    servoc_velocity = 0.25" + NEW_LINE +
//"    servoc_blend = 0" + NEW_LINE +
//"" + NEW_LINE +
...
"" + NEW_LINE +
"    global jog_feature_# 0 - base, 1 - tool, 2 - custom" + NEW_LINE +
"    global jog_speed_vector_dt" + NEW_LINE +
"    global jog_start_pose" + NEW_LINE +
"    global jog_thrd" + NEW_LINE +
"    global jog_dt" + NEW_LINE +
"    global jog_state_ # 0 - inactive, 1 - new setpoint, 2 - jogging, 3 - stopping (decelerating)" + NEW_LINE +
"" + NEW_LINE +
"    jog_feature_ = 0 # 0 - base, 1 - tool, 2 - custom" + NEW_LINE +
"    jog_speed_vector_dt = [0, 0, 0, 0, 0, 0]" + NEW_LINE +
"    jog_start_pose = [0, 0, 0, 0, 0, 0]" + NEW_LINE +
"    jog_thrd = 0" + NEW_LINE +
"    jog_dt = 0.004" + NEW_LINE +
"    jog_state_ = 0 # 0 - inactive, 1 - new setpoint, 2 - jogging, 3 - stopping (decelerating)" + NEW_LINE +
"" + NEW_LINE +
...
"            if type == 0:" + NEW_LINE +
"                if time > 0:" + NEW_LINE +
"                    speedl(target, acceleration, t=time)" + NEW_LINE +
"                else:" + NEW_LINE +
"                    speedl(target, acceleration)" + NEW_LINE +
"                end" + NEW_LINE +
"            else:" + NEW_LINE +
"                if time > 0:" + NEW_LINE +
"                    speedj(target, acceleration, time)" + NEW_LINE +
"                else:" + NEW_LINE +
"                    speedj(target, acceleration)" + NEW_LINE +
"                end" + NEW_LINE +
"            end" + NEW_LINE +
"        end" + NEW_LINE +
"    end" + NEW_LINE +
...
"        global servo_time" + NEW_LINE +
"        global servo_lookahead_time" + NEW_LINE +
"        last_time = 0" + NEW_LINE +
"        while (True):" + NEW_LINE +
"            lock.acquire()" + NEW_LINE +
"            q = copy.deepcopy(servo_target)" + NEW_LINE +
...
"        global jog_state_" + NEW_LINE +
"        global jog_start_pose" + NEW_LINE +
"        global jog_feature_" + NEW_LINE +
...
"        while (True):" + NEW_LINE +
"            lock.acquire()" + NEW_LINE +
"            if jog_state_ == 1: # 1 = new setpoint" + NEW_LINE +
"                speeds = jog_speed_vector_dt" + NEW_LINE +
"                jog_state_ = 2 # 2 = jogging" + NEW_LINE +
...
"            lock.release()" + NEW_LINE +
//"            textmsg(" + QUOTATION + "speed_target:" + QUOTATION + ",qd)" + NEW_LINE +
//"            textmsg(" + QUOTATION + "speed_acceleration:" + QUOTATION + ",speed_acceleration)" + NEW_LINE +
//"            textmsg(" + QUOTATION + "speed_time:" + QUOTATION + ",speed_time)" + NEW_LINE +
"" + NEW_LINE +
...
//"            stop_thread(servoc_thrd)" + NEW_LINE +
"            servo_thrd = 0" + NEW_LINE +
//"            servoc_thrd = 0" + NEW_LINE +
"            lock.release()" + NEW_LINE +
"            stopl(deceleration_rate)" + NEW_LINE +
...
"            textmsg(" + QUOTATION + "jog_feature_: " + QUOTATION + ", jog_feature_)" + NEW_LINE +
